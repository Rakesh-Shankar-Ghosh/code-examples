import { PopupBaseViewModel } from "survey-core/typings/src/popup-view-model";
...
export { activateLazyRenderingChecks, chooseFiles, classesToSelector, compareVersions, confirmAction, confirmActionAsync, createSvg, detectIEBrowser, detectIEOrEdge, findParentByClassNames, findScrollableParent, getElement, getElementWidth, getFirstVisibleChild, getIconNameFromProxy, getOriginalEvent, increaseHeightByContent, isBase64URL, isContainerVisible, isElementVisible, isMobile, isShadowDOM, loadFileFromBase64, mergeValues, navigateToUrl, preventDefaults, renamedIcons, updateListCssValues, wrapUrlForBackgroundImage };
