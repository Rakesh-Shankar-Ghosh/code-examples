import { Action, IAction } from "survey-core/typings/src/actions/action";
import { ActionContainer } from "survey-core/typings/src/actions/container";
import { Base, EventBase } from "survey-core/typings/src/base";
import { IDropdownMenuOptions, IElement, IFindElement, ILoadFromJSONOptions, IPage, IPanel, IPlainDataOptions, IProgressInfo, IQuestion, ISurvey, ISurveyData, ISurveyElement, ISurveyErrorOwner, ISurveyImpl, ISurveyLayoutElement, ITextProcessor, ITextProcessorProp, ITextProcessorResult, IValueItemCustomPropValues, LayoutElementContainer } from "survey-core/typings/src/base-interfaces";
import { CalculatedValue } from "survey-core/typings/src/calculatedValue";
import { HtmlConditionItem, UrlConditionItem } from "survey-core/typings/src/expressionItems";
import { Cover } from "survey-core/typings/src/header";
import { ItemValue } from "survey-core/typings/src/itemvalue";
import { JsonError } from "survey-core/typings/src/jsonobject";
import { LocalizableString } from "survey-core/typings/src/localizablestring";
import { Notifier } from "survey-core/typings/src/notifier";
import { PageModel } from "survey-core/typings/src/page";
import { PanelModel, QuestionRowModel } from "survey-core/typings/src/panel";
import { PopupModel } from "survey-core/typings/src/popup";
import { IQuestionPlainData, Question } from "survey-core/typings/src/question";
import { QuestionSelectBase } from "survey-core/typings/src/question_baseselect";
import { QuestionFileModel } from "survey-core/typings/src/question_file";
import { QuestionMatrixDropdownModelBase } from "survey-core/typings/src/question_matrixdropdownbase";
import { QuestionMatrixDynamicModel } from "survey-core/typings/src/question_matrixdynamic";
import { QuestionMultipleTextModel } from "survey-core/typings/src/question_multipletext";
import { QuestionPanelDynamicModel } from "survey-core/typings/src/question_paneldynamic";
import { QuestionSignaturePadModel } from "survey-core/typings/src/question_signaturepad";
import { SurveyElementCore } from "survey-core/typings/src/survey-element";
import { SurveyError } from "survey-core/typings/src/survey-error";
import { AfterRenderPageEvent, AfterRenderPanelEvent, AfterRenderQuestionEvent, AfterRenderQuestionInputEvent, AfterRenderSurveyEvent, CheckAnswerCorrectEvent, ChoicesLazyLoadEvent, ChoicesLoadedEvent, ChoicesSearchEvent, ClearFilesEvent, CompleteEvent, CompletingEvent, CurrentPageChangedEvent, CurrentPageChangingEvent, DownloadFileEvent, DragDropAllowEvent, DynamicPanelCurrentIndexChangedEvent, DynamicPanelGetTabTitleEvent, DynamicPanelItemValueChangedEvent, DynamicPanelModifiedEvent, DynamicPanelRemovingEvent, DynamicPanelValueChangingEvent, ErrorCustomTextEvent, FocusInPanelEvent, FocusInQuestionEvent, GetChoiceDisplayValueEvent, GetExpressionDisplayValueEvent, GetMatrixRowActionsEvent, GetPageNumberEvent, GetPageTitleActionsEvent, GetPanelFooterActionsEvent, GetPanelNumberEvent, GetPanelTitleActionsEvent, GetProgressTextEvent, GetQuestionDisplayValueEvent, GetQuestionNumberEvent, GetQuestionTitleActionsEvent, GetQuestionTitleEvent, GetResultEvent, GetTitleTagNameEvent, IsAnswerCorrectEvent, LoadChoicesFromServerEvent, MatrixAfterCellRenderEvent, MatrixAllowRemoveRowEvent, MatrixBeforeRowAddedEvent, MatrixCellCreatedEvent, MatrixCellCreatingEvent, MatrixCellValidateEvent, MatrixCellValueChangedEvent, MatrixCellValueChangingEvent, MatrixColumnAddedEvent, MatrixDetailPanelVisibleChangedEvent, MatrixRowAddedEvent, MatrixRowRemovedEvent, MatrixRowRemovingEvent, MultipleTextItemAddedEvent, NavigateToUrlEvent, OpenDropdownMenuEvent, OpenFileChooserEvent, PageAddedEvent, PageVisibleChangedEvent, PanelAddedEvent, PanelRemovedEvent, PanelVisibleChangedEvent, PopupVisibleChangedEvent, ProcessDynamicTextEvent, ProcessHtmlEvent, ProcessTextValueEvent, ProgressTextEvent, QuestionAddedEvent, QuestionCreatedEvent, QuestionRemovedEvent, QuestionVisibleChangedEvent, ResizeEvent, ScrollToTopEvent, ScrollingElementToTopEvent, SendResultEvent, ServerValidateQuestionsEvent, SettingQuestionErrorsEvent, ShowingChoiceItemEvent, ShowingPreviewEvent, TextMarkdownEvent, TriggerExecutedEvent, UpdateChoiceItemCssEvent, UpdatePageCssClassesEvent, UpdatePanelCssClassesEvent, UpdateQuestionCssClassesEvent, UploadFilesEvent, ValidatePageEvent, ValidatePanelEvent, ValidateQuestionEvent, ValidatedErrorsOnCurrentPageEvent, ValueChangedEvent, ValueChangingEvent, VariableChangedEvent } from "survey-core/typings/src/survey-events-api";
import { ISurveyTimerText, SurveyTimerModel } from "survey-core/typings/src/surveyTimerModel";
import { ITheme, ImageAttachment, ImageFit } from "survey-core/typings/src/themes";
import { ISurveyTriggerOwner, SurveyTrigger, Trigger } from "survey-core/typings/src/trigger";
/**
