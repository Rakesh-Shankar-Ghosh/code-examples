import { IColumn, IColumnData, IPermission, ITableState, QuestionLocation } from "survey-analytics/survey-analytics-tabulator.types/tables/config";
import { Details } from "survey-analytics/survey-analytics-tabulator.types/tables/extensions/detailsextensions";
import { ITableExtension, TableExtensions } from "survey-analytics/survey-analytics-tabulator.types/tables/extensions/tableextensions";
import { Event, EventBase, Question, SurveyModel } from "survey-core";
