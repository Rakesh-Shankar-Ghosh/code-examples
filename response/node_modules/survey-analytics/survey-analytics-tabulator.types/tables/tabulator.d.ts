import { IColumnData, QuestionLocation } from "survey-analytics/survey-analytics-tabulator.types/tables/config";
import { GetDataFn, ITableOptions, Table, TableRow } from "survey-analytics/survey-analytics-tabulator.types/tables/table";
import "survey-analytics/survey-analytics-tabulator.types/tables/tabulator.scss";
